...
goog.exportSymbol('proto.palm.portal.v1.SiteTimezonesResponse.Item', null, global);
 ...
 * @constructor
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.portal.v1.SiteTimezonesResponse.Item, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.portal.v1.SiteTimezonesResponse.Item.displayName = 'proto.palm.portal.v1.SiteTimezonesResponse.Item';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.palm.portal.v1.SiteTimezonesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    proto.palm.portal.v1.SiteTimezonesResponse.Item.toObject, includeInstance)
  };
...
proto.palm.portal.v1.SiteTimezonesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.palm.portal.v1.SiteTimezonesResponse.Item;
      reader.readMessage(value,proto.palm.portal.v1.SiteTimezonesResponse.Item.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
...
proto.palm.portal.v1.SiteTimezonesResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.palm.portal.v1.SiteTimezonesResponse.Item.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.portal.v1.SiteTimezonesResponse.Item.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.portal.v1.SiteTimezonesResponse.Item} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.portal.v1.SiteTimezonesResponse.Item}
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.portal.v1.SiteTimezonesResponse.Item;
  return proto.palm.portal.v1.SiteTimezonesResponse.Item.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.portal.v1.SiteTimezonesResponse.Item} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.portal.v1.SiteTimezonesResponse.Item}
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.portal.v1.SiteTimezonesResponse.Item.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.portal.v1.SiteTimezonesResponse.Item} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.portal.v1.SiteTimezonesResponse.Item.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
...
/**
 * repeated Item items = 1;
 * @return {!Array<!proto.palm.portal.v1.SiteTimezonesResponse.Item>}
 */
proto.palm.portal.v1.SiteTimezonesResponse.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.palm.portal.v1.SiteTimezonesResponse.Item>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.palm.portal.v1.SiteTimezonesResponse.Item, 1));
};


/**
 * @param {!Array<!proto.palm.portal.v1.SiteTimezonesResponse.Item>} value
...
/**
 * @param {!proto.palm.portal.v1.SiteTimezonesResponse.Item=} opt_value
 * @param {number=} opt_index
 * @return {!proto.palm.portal.v1.SiteTimezonesResponse.Item}
 */
proto.palm.portal.v1.SiteTimezonesResponse.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.palm.portal.v1.SiteTimezonesResponse.Item, opt_index);
};
