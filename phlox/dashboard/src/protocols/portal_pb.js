...
data: (f = msg.getData()) && proto.palm.portal.v1.Theme.Bootstrap.Sample.Data.toObject(includeInstance, f)
  };
...
proto.palm.portal.v1.Theme.Bootstrap.Sample.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.palm.portal.v1.Theme.Bootstrap.Sample.Data;
      reader.readMessage(value,proto.palm.portal.v1.Theme.Bootstrap.Sample.Data.deserializeBinaryFromReader);
      msg.setData(value);
      break;
    default:
      reader.skipField();
...
proto.palm.portal.v1.Theme.Bootstrap.Sample.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.palm.portal.v1.Theme.Bootstrap.Sample.Data.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.palm.portal.v1.Theme.Bootstrap.Sample.Data.Body.Item.prototype.getPropertiesMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.palm.portal.v1.Theme.Bootstrap.Sample.Data.Body.Item} returns this
 */
proto.palm.portal.v1.Theme.Bootstrap.Sample.Data.Body.Item.prototype.clearPropertiesMap = function() {
...
proto.palm.portal.v1.Theme.Bootstrap.Sample.prototype.getData = function() {
  return /** @type{?proto.palm.portal.v1.Theme.Bootstrap.Sample.Data} */ (
    jspb.Message.getWrapperField(this, proto.palm.portal.v1.Theme.Bootstrap.Sample.Data, 2));
};


/**
 * @param {?proto.palm.portal.v1.Theme.Bootstrap.Sample.Data|undefined} value
 * @return {!proto.palm.portal.v1.Theme.Bootstrap.Sample} returns this
*/
 ...
 * @return {!proto.palm.portal.v1.Theme.Bootstrap.Sample} returns this
 */
proto.palm.portal.v1.Theme.Bootstrap.Sample.prototype.clearData = function() {
 ...
 * @return {boolean}
 */
proto.palm.portal.v1.Theme.Bootstrap.Sample.prototype.hasData = function() {
  return jspb.Message.getField(this, 2) != null;
};
