...
public final class MarkdownGrpc {
   ...
   */
  public static MarkdownBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MarkdownBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MarkdownBlockingV2Stub>() {
        @java.lang.Override
        public MarkdownBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new MarkdownBlockingV2Stub(channel, callOptions);
        }
      };
    return MarkdownBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class MarkdownBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<MarkdownBlockingV2Stub> {
    private MarkdownBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected MarkdownBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new MarkdownBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Markdown.
   */
