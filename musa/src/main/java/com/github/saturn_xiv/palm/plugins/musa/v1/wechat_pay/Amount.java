...
public class Amount implements org.apache.thrift.TBase<Amount, Amount._Fields>, java.io.Serializable, Cloneable, Comparable<Amount> {
  ...
  private static final org.apache.thrift.protocol.TField CURRENTY_FIELD_DESC = new org.apache.thrift.protocol.TField("currenty", org.apache.thrift.protocol.TType.I32, (short)2);
   ...
   * @see Currency
   */
  public @org.apache.thrift.annotation.Nullable Currency currenty; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.CURRENTY, new org.apache.thrift.meta_data.FieldMetaData("currenty", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public Amount setTotal(int total) {
    this.total = total;
    setTotalIsSet(true);
    return this;
  }
   ...
   * @see Currency
   */
  public Amount setCurrenty(@org.apache.thrift.annotation.Nullable Currency currenty) {
    this.currenty = currenty;
    return this;
  }

  public void unsetCurrenty() {
    this.currenty = null;
  }

  /** Returns true if field currenty is set (has been assigned a value) and false otherwise */
  public boolean isSetCurrenty() {
    return this.currenty != null;
  }

  public void setCurrentyIsSet(boolean value) {
    if (!value) {
      this.currenty = null;
    }
  }
  ...
  public boolean equals(Amount that) {
    ...
    boolean this_present_currenty = true && this.isSetCurrenty();
    boolean that_present_currenty = true && that.isSetCurrenty();
    if (this_present_currenty || that_present_currenty) {
      if (!(this_present_currenty && that_present_currenty))
        return false;
      if (!this.currenty.equals(that.currenty))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCurrenty()) ? 131071 : 524287);
    if (isSetCurrenty())
      hashCode = hashCode * 8191 + currenty.getValue();
  ...
  public int compareTo(Amount other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCurrenty(), other.isSetCurrenty());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCurrenty()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.currenty, other.currenty);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class AmountStandardScheme extends org.apache.thrift.scheme.StandardScheme<Amount> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Amount struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // CURRENTY
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.currenty = com.github.saturn_xiv.palm.plugins.musa.v1.wechat_pay.Currency.findByValue(iprot.readI32());
              struct.setCurrentyIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Amount struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.currenty != null) {
        oprot.writeFieldBegin(CURRENTY_FIELD_DESC);
        oprot.writeI32(struct.currenty.getValue());
        oprot.writeFieldEnd();
      }
