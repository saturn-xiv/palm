...
const (
	S3_Upload_FullMethodName       = "/palm.petunia.s3.v1.S3/Upload"
	S3_PresignedUrl_FullMethodName = "/palm.petunia.s3.v1.S3/PresignedUrl"
	S3_PermanentUrl_FullMethodName = "/palm.petunia.s3.v1.S3/PermanentUrl"
)
...
var S3_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.petunia.s3.v1.S3",
