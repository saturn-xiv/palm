...
const (
	Policy_Can_FullMethodName                           = "/palm.petunia.rbac.v1.Policy/Can"
	Policy_Has_FullMethodName                           = "/palm.petunia.rbac.v1.Policy/Has"
	Policy_AddRolesForUser_FullMethodName               = "/palm.petunia.rbac.v1.Policy/AddRolesForUser"
	Policy_GetImplicitRolesForUser_FullMethodName       = "/palm.petunia.rbac.v1.Policy/GetImplicitRolesForUser"
	Policy_GetRolesForUser_FullMethodName               = "/palm.petunia.rbac.v1.Policy/GetRolesForUser"
	Policy_DeleteUser_FullMethodName                    = "/palm.petunia.rbac.v1.Policy/DeleteUser"
	Policy_GetUsersForRole_FullMethodName               = "/palm.petunia.rbac.v1.Policy/GetUsersForRole"
	Policy_GetImplicitUsersForRole_FullMethodName       = "/palm.petunia.rbac.v1.Policy/GetImplicitUsersForRole"
	Policy_DeleteRole_FullMethodName                    = "/palm.petunia.rbac.v1.Policy/DeleteRole"
	Policy_DeleteRolesForUser_FullMethodName            = "/palm.petunia.rbac.v1.Policy/DeleteRolesForUser"
	Policy_AddPermissionsForUser_FullMethodName         = "/palm.petunia.rbac.v1.Policy/AddPermissionsForUser"
	Policy_GetPermissionsForUser_FullMethodName         = "/palm.petunia.rbac.v1.Policy/GetPermissionsForUser"
	Policy_GetImplicitPermissionsForUser_FullMethodName = "/palm.petunia.rbac.v1.Policy/GetImplicitPermissionsForUser"
	Policy_DeletePermissionsForUser_FullMethodName      = "/palm.petunia.rbac.v1.Policy/DeletePermissionsForUser"
	Policy_AddPermissionsForRole_FullMethodName         = "/palm.petunia.rbac.v1.Policy/AddPermissionsForRole"
	Policy_GetPermissionsForRole_FullMethodName         = "/palm.petunia.rbac.v1.Policy/GetPermissionsForRole"
	Policy_GetImplicitPermissionsForRole_FullMethodName = "/palm.petunia.rbac.v1.Policy/GetImplicitPermissionsForRole"
	Policy_DeletePermissionsForRole_FullMethodName      = "/palm.petunia.rbac.v1.Policy/DeletePermissionsForRole"
)
...
var Policy_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.petunia.rbac.v1.Policy",
