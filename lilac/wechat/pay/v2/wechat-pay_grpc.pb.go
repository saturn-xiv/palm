...
const (
	WechatPayNative_Prepay_FullMethodName = "/palm.lilac.wechat.pay.v1.WechatPayNative/Prepay"
)
...
var WechatPayNative_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.lilac.wechat.pay.v1.WechatPayNative",
...
const (
	WechatPayJsapi_Prepay_FullMethodName                 = "/palm.lilac.wechat.pay.v1.WechatPayJsapi/Prepay"
	WechatPayJsapi_QueryOrderByOutTradeNo_FullMethodName = "/palm.lilac.wechat.pay.v1.WechatPayJsapi/QueryOrderByOutTradeNo"
	WechatPayJsapi_QueryOrderById_FullMethodName         = "/palm.lilac.wechat.pay.v1.WechatPayJsapi/QueryOrderById"
	WechatPayJsapi_CloseOrder_FullMethodName             = "/palm.lilac.wechat.pay.v1.WechatPayJsapi/CloseOrder"
)
...
var WechatPayJsapi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.lilac.wechat.pay.v1.WechatPayJsapi",
...
const (
	WechatPayBill_Trade_FullMethodName    = "/palm.lilac.wechat.pay.v1.WechatPayBill/Trade"
	WechatPayBill_FundFlow_FullMethodName = "/palm.lilac.wechat.pay.v1.WechatPayBill/FundFlow"
)
...
var WechatPayBill_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.lilac.wechat.pay.v1.WechatPayBill",
...
const (
	WechatPayRefund_Create_FullMethodName = "/palm.lilac.wechat.pay.v1.WechatPayRefund/Create"
	WechatPayRefund_Query_FullMethodName  = "/palm.lilac.wechat.pay.v1.WechatPayRefund/Query"
)
...
var WechatPayRefund_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.lilac.wechat.pay.v1.WechatPayRefund",
...
const (
	WechatPayTransfer_ExecuteBatch_FullMethodName         = "/palm.lilac.wechat.pay.v1.WechatPayTransfer/ExecuteBatch"
	WechatPayTransfer_QueryBatch_FullMethodName           = "/palm.lilac.wechat.pay.v1.WechatPayTransfer/QueryBatch"
	WechatPayTransfer_QueryDetail_FullMethodName          = "/palm.lilac.wechat.pay.v1.WechatPayTransfer/QueryDetail"
	WechatPayTransfer_GetBillReceipt_FullMethodName       = "/palm.lilac.wechat.pay.v1.WechatPayTransfer/GetBillReceipt"
	WechatPayTransfer_GetElectronicReceipt_FullMethodName = "/palm.lilac.wechat.pay.v1.WechatPayTransfer/GetElectronicReceipt"
)
...
var WechatPayTransfer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "palm.lilac.wechat.pay.v1.WechatPayTransfer",
