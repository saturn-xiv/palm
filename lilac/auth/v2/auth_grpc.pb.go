...
type UserClient interface {
	Can(ctx context.Context, in *v2.Permission, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Has(ctx context.Context, in *v2.Role, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userClient) Can(ctx context.Context, in *v2.Permission, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *userClient) Has(ctx context.Context, in *v2.Role, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserServer interface {
	Can(context.Context, *v2.Permission) (*emptypb.Empty, error)
	Has(context.Context, *v2.Role) (*emptypb.Empty, error)
...
func (UnimplementedUserServer) Can(context.Context, *v2.Permission) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Can not implemented")
}
func (UnimplementedUserServer) Has(context.Context, *v2.Role) (*emptypb.Empty, error) {
...
func _User_Can_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Can(ctx, req.(*v2.Permission))
	}
...
func _User_Has_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Has(ctx, req.(*v2.Role))
	}
	return interceptor(ctx, in, info, handler)
}
