...
//   // for (auto i = 0; i < PALM_LOOP_COUNT; i++) {
//   //   std::cout << palm::base64::encode(palm::random::bytes(16)) <<
//   std::endl;
//   // }
// }
...
//   // This padding means when your data is not a multiple of the block size,
//   you
//   // pad n bytes of the value n, where n is however many bytes you need to
//   get
