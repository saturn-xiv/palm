...
**status** | Option<[**models::CallEnumStatus**](CallEnumStatus.md)> |  | [optional]
...
**subresource_uris** | Option<**serde_json::Value**> | A list of subresources available to this call, identified by their URIs relative to `https://api.twilio.com`. | [optional]
