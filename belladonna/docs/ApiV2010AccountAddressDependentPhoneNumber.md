...
**address_requirements** | Option<[**models::DependentPhoneNumberEnumAddressRequirement**](DependentPhoneNumberEnumAddressRequirement.md)> |  | [optional]
**capabilities** | Option<**serde_json::Value**> | The set of Boolean properties that indicates whether a phone number can receive calls or messages.  Capabilities are  `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`. | [optional]
...
**emergency_status** | Option<[**models::DependentPhoneNumberEnumEmergencyStatus**](DependentPhoneNumberEnumEmergencyStatus.md)> |  | [optional]
