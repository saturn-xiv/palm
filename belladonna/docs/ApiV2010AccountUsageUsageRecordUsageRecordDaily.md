...
**end_date** | Option<**chrono::NaiveDate**> | The last date for which usage is included in the UsageRecord. The date is specified in GMT and formatted as `YYYY-MM-DD`. | [optional]
...
**start_date** | Option<**chrono::NaiveDate**> | The first date for which usage is included in this UsageRecord. The date is specified in GMT and formatted as `YYYY-MM-DD`. | [optional]
