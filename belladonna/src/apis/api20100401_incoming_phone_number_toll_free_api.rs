...
pub struct CreateIncomingPhoneNumberTollFreeParams {
    ...
    pub emergency_status: Option<models::models::IncomingPhoneNumberTollFreeEnumEmergencyStatus>,
    ...
    pub voice_receive_mode: Option<models::models::IncomingPhoneNumberTollFreeEnumVoiceReceiveMode>,
