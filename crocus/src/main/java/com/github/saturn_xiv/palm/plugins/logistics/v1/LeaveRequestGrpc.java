...
public final class LeaveRequestGrpc {
   ...
   */
  public static LeaveRequestBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<LeaveRequestBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<LeaveRequestBlockingV2Stub>() {
        @java.lang.Override
        public LeaveRequestBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new LeaveRequestBlockingV2Stub(channel, callOptions);
        }
      };
    return LeaveRequestBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class LeaveRequestBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<LeaveRequestBlockingV2Stub> {
    private LeaveRequestBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected LeaveRequestBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new LeaveRequestBlockingV2Stub(channel, callOptions);
    }
  }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service LeaveRequest.
   */
