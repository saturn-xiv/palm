...
public final class CbetaGrpc {
   ...
   */
  public static CbetaBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CbetaBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CbetaBlockingV2Stub>() {
        @java.lang.Override
        public CbetaBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new CbetaBlockingV2Stub(channel, callOptions);
        }
      };
    return CbetaBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class CbetaBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<CbetaBlockingV2Stub> {
    private CbetaBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CbetaBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CbetaBlockingV2Stub(channel, callOptions);
    }
  }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Cbeta.
   */
