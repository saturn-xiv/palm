...
public final class LibraryGrpc {
   ...
   */
  public static LibraryBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<LibraryBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<LibraryBlockingV2Stub>() {
        @java.lang.Override
        public LibraryBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new LibraryBlockingV2Stub(channel, callOptions);
        }
      };
    return LibraryBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class LibraryBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<LibraryBlockingV2Stub> {
    private LibraryBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected LibraryBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new LibraryBlockingV2Stub(channel, callOptions);
    }
  }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Library.
   */
