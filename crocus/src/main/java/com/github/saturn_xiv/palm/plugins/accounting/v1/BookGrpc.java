...
public final class BookGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "palm.accounting.v1.Book";
   ...
   */
  public static BookBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<BookBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<BookBlockingV2Stub>() {
        @java.lang.Override
        public BookBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new BookBlockingV2Stub(channel, callOptions);
        }
      };
    return BookBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class BookBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<BookBlockingV2Stub> {
    private BookBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected BookBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new BookBlockingV2Stub(channel, callOptions);
    }
  }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Book.
   */
  ...
  private static abstract class BookBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.github.saturn_xiv.palm.plugins.accounting.v1.AccountingProto.getDescriptor();
    }
