...
public final class StoreGrpc {
   ...
   */
  public static StoreBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<StoreBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<StoreBlockingV2Stub>() {
        @java.lang.Override
        public StoreBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new StoreBlockingV2Stub(channel, callOptions);
        }
      };
    return StoreBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class StoreBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<StoreBlockingV2Stub> {
    private StoreBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected StoreBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new StoreBlockingV2Stub(channel, callOptions);
    }
  }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Store.
   */
