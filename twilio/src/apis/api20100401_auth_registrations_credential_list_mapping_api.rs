...
pub async fn create_sip_auth_registrations_credential_list_mapping(configuration: &configuration::Configuration, params: CreateSipAuthRegistrationsCredentialListMappingParams) -> Result<models::ApiV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping, Error<CreateSipAuthRegistrationsCredentialListMappingError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateSipAuthRegistrationsCredentialListMappingError> = serde_json::from_str(&content).ok();
...
pub async fn delete_sip_auth_registrations_credential_list_mapping(configuration: &configuration::Configuration, params: DeleteSipAuthRegistrationsCredentialListMappingParams) -> Result<(), Error<DeleteSipAuthRegistrationsCredentialListMappingError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteSipAuthRegistrationsCredentialListMappingError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn fetch_sip_auth_registrations_credential_list_mapping(configuration: &configuration::Configuration, params: FetchSipAuthRegistrationsCredentialListMappingParams) -> Result<models::ApiV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping, Error<FetchSipAuthRegistrationsCredentialListMappingError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FetchSipAuthRegistrationsCredentialListMappingError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn list_sip_auth_registrations_credential_list_mapping(configuration: &configuration::Configuration, params: ListSipAuthRegistrationsCredentialListMappingParams) -> Result<models::ListSipAuthRegistrationsCredentialListMappingResponse, Error<ListSipAuthRegistrationsCredentialListMappingError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListSipAuthRegistrationsCredentialListMappingError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
