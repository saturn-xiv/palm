...
pub async fn delete_recording(configuration: &configuration::Configuration, params: DeleteRecordingParams) -> Result<(), Error<DeleteRecordingError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Recordings/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn fetch_recording(configuration: &configuration::Configuration, params: FetchRecordingParams) -> Result<models::ApiV2010AccountRecording, Error<FetchRecordingError>> {
...
pub async fn list_recording(configuration: &configuration::Configuration, params: ListRecordingParams) -> Result<models::ListRecordingResponse, Error<ListRecordingError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Recordings.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
