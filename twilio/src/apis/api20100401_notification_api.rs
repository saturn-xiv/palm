...
pub async fn fetch_notification(configuration: &configuration::Configuration, params: FetchNotificationParams) -> Result<models::ApiV2010AccountNotificationInstance, Error<FetchNotificationError>> {

    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Notifications/{Sid}.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid), Sid=crate::apis::urlencode(params.sid));
...
pub async fn list_notification(configuration: &configuration::Configuration, params: ListNotificationParams) -> Result<models::ListNotificationResponse, Error<ListNotificationError>> {
    ...
    let uri_str = format!("{}/2010-04-01/Accounts/{AccountSid}/Notifications.json", configuration.base_path, AccountSid=crate::apis::urlencode(params.account_sid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
