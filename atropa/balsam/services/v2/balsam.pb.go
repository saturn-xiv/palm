...
var file_balsam_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x32, 0xa1, 0x01, 0x0a, 0x03, 0x41,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x42, 0x66, 0x0a, 0x2c, 0x63, 0x6f, 0x6d, 0x2e,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x73, 0x61, 0x74, 0x75, 0x72, 0x6e, 0x5f, 0x78, 0x69,
	0x76, 0x2e, 0x70, 0x61, 0x6c, 0x6d, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2e, 0x62,
	0x61, 0x6c, 0x73, 0x61, 0x6d, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x61, 0x74, 0x75, 0x72, 0x6e, 0x2d, 0x78, 0x69,
	0x76, 0x2f, 0x70, 0x61, 0x6c, 0x6d, 0x2f, 0x61, 0x74, 0x72, 0x6f, 0x70, 0x61, 0x2f, 0x62, 0x61,
	0x6c, 0x73, 0x61, 0x6d, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x32,
...
var file_balsam_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_balsam_proto_msgTypes = make([]protoimpl.MessageInfo, 48)
var file_balsam_proto_goTypes = []interface{}{
	(UserLogsResponse_Item_Level)(0),                // 0: palm.balsam.v1.UserLogsResponse.Item.Level
	(UserSignInResponse_Detail_ProviderType)(0),     // 1: palm.balsam.v1.UserSignInResponse.Detail.ProviderType
	(WechatOauth2UserIndexResponse_Item_Sex)(0),     // 2: palm.balsam.v1.WechatOauth2UserIndexResponse.Item.Sex
	(WechatOauth2UserIndexResponse_Item_Lang)(0),    // 3: palm.balsam.v1.WechatOauth2UserIndexResponse.Item.Lang
	(*IdRequest)(nil),                               // 4: palm.balsam.v1.IdRequest
	(*UidRequest)(nil),                              // 5: palm.balsam.v1.UidRequest
	(*Pager)(nil),                                   // 6: palm.balsam.v1.Pager
	(*AesPlainMessage)(nil),                         // 7: palm.balsam.v1.AesPlainMessage
	(*AesCodeMessage)(nil),                          // 8: palm.balsam.v1.AesCodeMessage
	(*JwtSignRequest)(nil),                          // 9: palm.balsam.v1.JwtSignRequest
	(*JwtSignResponse)(nil),                         // 10: palm.balsam.v1.JwtSignResponse
	(*JwtVerifyRequest)(nil),                        // 11: palm.balsam.v1.JwtVerifyRequest
	(*JwtVerifyResponse)(nil),                       // 12: palm.balsam.v1.JwtVerifyResponse
	(*HMacSignRequest)(nil),                         // 13: palm.balsam.v1.HMacSignRequest
	(*HMacSignResponse)(nil),                        // 14: palm.balsam.v1.HMacSignResponse
	(*HMacVerifyRequest)(nil),                       // 15: palm.balsam.v1.HMacVerifyRequest
	(*UserUpdateProfileRequest)(nil),                // 16: palm.balsam.v1.UserUpdateProfileRequest
	(*UserIndexResponse)(nil),                       // 17: palm.balsam.v1.UserIndexResponse
	(*LogsRequest)(nil),                             // 18: palm.balsam.v1.LogsRequest
	(*UserLogsResponse)(nil),                        // 19: palm.balsam.v1.UserLogsResponse
	(*EmailUserByEmailRequest)(nil),                 // 20: palm.balsam.v1.EmailUserByEmailRequest
	(*EmailUserByNicknameRequest)(nil),              // 21: palm.balsam.v1.EmailUserByNicknameRequest
	(*EmailUserIndexResponse)(nil),                  // 22: palm.balsam.v1.EmailUserIndexResponse
	(*UserResetPasswordRequest)(nil),                // 23: palm.balsam.v1.UserResetPasswordRequest
	(*UserByEmailRequest)(nil),                      // 24: palm.balsam.v1.UserByEmailRequest
	(*UserByTokenRequest)(nil),                      // 25: palm.balsam.v1.UserByTokenRequest
	(*UserSignInByEmailRequest)(nil),                // 26: palm.balsam.v1.UserSignInByEmailRequest
	(*UserSignUpByEmailRequest)(nil),                // 27: palm.balsam.v1.UserSignUpByEmailRequest
	(*UserSignInResponse)(nil),                      // 28: palm.balsam.v1.UserSignInResponse
	(*GoogleOauth2UserBySubjectRequest)(nil),        // 29: palm.balsam.v1.GoogleOauth2UserBySubjectRequest
	(*GoogleOauth2UserIndexResponse)(nil),           // 30: palm.balsam.v1.GoogleOauth2UserIndexResponse
	(*WechatByUnionIdRequest)(nil),                  // 31: palm.balsam.v1.WechatByUnionIdRequest
	(*WechatByAppIdAndOpenIdRequest)(nil),           // 32: palm.balsam.v1.WechatByAppIdAndOpenIdRequest
	(*WechatOauth2UserIndexResponse)(nil),           // 33: palm.balsam.v1.WechatOauth2UserIndexResponse
	(*WechatMiniProgramUserIndexResponse)(nil),      // 34: palm.balsam.v1.WechatMiniProgramUserIndexResponse
	(*SessionIndexResponse)(nil),                    // 35: palm.balsam.v1.SessionIndexResponse
	(*AttachmentCreateRequest)(nil),                 // 36: palm.balsam.v1.AttachmentCreateRequest
	(*AttachmentByResourceRequest)(nil),             // 37: palm.balsam.v1.AttachmentByResourceRequest
	(*AttachmentSetTitleRequest)(nil),               // 38: palm.balsam.v1.AttachmentSetTitleRequest
	(*AttachmentShowResponse)(nil),                  // 39: palm.balsam.v1.AttachmentShowResponse
	(*AttachmentIndexResponse)(nil),                 // 40: palm.balsam.v1.AttachmentIndexResponse
	(*UserIndexResponse_Item)(nil),                  // 41: palm.balsam.v1.UserIndexResponse.Item
	(*UserLogsResponse_Item)(nil),                   // 42: palm.balsam.v1.UserLogsResponse.Item
	(*EmailUserIndexResponse_Item)(nil),             // 43: palm.balsam.v1.EmailUserIndexResponse.Item
	(*UserSignInResponse_Detail)(nil),               // 44: palm.balsam.v1.UserSignInResponse.Detail
	(*UserSignInResponse_Permission)(nil),           // 45: palm.balsam.v1.UserSignInResponse.Permission
	(*UserSignInResponse_Menu)(nil),                 // 46: palm.balsam.v1.UserSignInResponse.Menu
	(*GoogleOauth2UserIndexResponse_Item)(nil),      // 47: palm.balsam.v1.GoogleOauth2UserIndexResponse.Item
	(*WechatOauth2UserIndexResponse_Item)(nil),      // 48: palm.balsam.v1.WechatOauth2UserIndexResponse.Item
	(*WechatMiniProgramUserIndexResponse_Item)(nil), // 49: palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item
	(*SessionIndexResponse_Item)(nil),               // 50: palm.balsam.v1.SessionIndexResponse.Item
	(*AttachmentIndexResponse_Item)(nil),            // 51: palm.balsam.v1.AttachmentIndexResponse.Item
	(*timestamppb.Timestamp)(nil),                   // 52: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),                     // 53: google.protobuf.Duration
	(*emptypb.Empty)(nil),                           // 54: google.protobuf.Empty
}
var file_balsam_proto_depIdxs = []int32{
	52,  // 0: palm.balsam.v1.JwtSignRequest.not_before:type_name -> google.protobuf.Timestamp
	52,  // 1: palm.balsam.v1.JwtSignRequest.expires_at:type_name -> google.protobuf.Timestamp
	41,  // 2: palm.balsam.v1.UserIndexResponse.items:type_name -> palm.balsam.v1.UserIndexResponse.Item
	42,  // 3: palm.balsam.v1.UserLogsResponse.items:type_name -> palm.balsam.v1.UserLogsResponse.Item
	43,  // 4: palm.balsam.v1.EmailUserIndexResponse.items:type_name -> palm.balsam.v1.EmailUserIndexResponse.Item
	53,  // 5: palm.balsam.v1.UserSignInByEmailRequest.ttl:type_name -> google.protobuf.Duration
	53,  // 6: palm.balsam.v1.UserSignUpByEmailRequest.ttl:type_name -> google.protobuf.Duration
	44,  // 7: palm.balsam.v1.UserSignInResponse.detail:type_name -> palm.balsam.v1.UserSignInResponse.Detail
	45,  // 8: palm.balsam.v1.UserSignInResponse.permissions:type_name -> palm.balsam.v1.UserSignInResponse.Permission
	46,  // 9: palm.balsam.v1.UserSignInResponse.menus:type_name -> palm.balsam.v1.UserSignInResponse.Menu
	47,  // 10: palm.balsam.v1.GoogleOauth2UserIndexResponse.items:type_name -> palm.balsam.v1.GoogleOauth2UserIndexResponse.Item
	48,  // 11: palm.balsam.v1.WechatOauth2UserIndexResponse.items:type_name -> palm.balsam.v1.WechatOauth2UserIndexResponse.Item
	49,  // 12: palm.balsam.v1.WechatMiniProgramUserIndexResponse.items:type_name -> palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item
	50,  // 13: palm.balsam.v1.SessionIndexResponse.items:type_name -> palm.balsam.v1.SessionIndexResponse.Item
	51,  // 14: palm.balsam.v1.AttachmentIndexResponse.items:type_name -> palm.balsam.v1.AttachmentIndexResponse.Item
	52,  // 15: palm.balsam.v1.UserIndexResponse.Item.current_sign_in_at:type_name -> google.protobuf.Timestamp
	52,  // 16: palm.balsam.v1.UserIndexResponse.Item.last_sign_in_at:type_name -> google.protobuf.Timestamp
	52,  // 17: palm.balsam.v1.UserIndexResponse.Item.lockeda_at:type_name -> google.protobuf.Timestamp
	52,  // 18: palm.balsam.v1.UserIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 19: palm.balsam.v1.UserIndexResponse.Item.updated_at:type_name -> google.protobuf.Timestamp
	0,   // 20: palm.balsam.v1.UserLogsResponse.Item.level:type_name -> palm.balsam.v1.UserLogsResponse.Item.Level
	52,  // 21: palm.balsam.v1.UserLogsResponse.Item.created_at:type_name -> google.protobuf.Timestamp
	52,  // 22: palm.balsam.v1.EmailUserIndexResponse.Item.confirmed_at:type_name -> google.protobuf.Timestamp
	52,  // 23: palm.balsam.v1.EmailUserIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 24: palm.balsam.v1.EmailUserIndexResponse.Item.updated_at:type_name -> google.protobuf.Timestamp
	1,   // 25: palm.balsam.v1.UserSignInResponse.Detail.provider_type:type_name -> palm.balsam.v1.UserSignInResponse.Detail.ProviderType
	46,  // 26: palm.balsam.v1.UserSignInResponse.Menu.menus:type_name -> palm.balsam.v1.UserSignInResponse.Menu
	52,  // 27: palm.balsam.v1.GoogleOauth2UserIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 28: palm.balsam.v1.GoogleOauth2UserIndexResponse.Item.updated_at:type_name -> google.protobuf.Timestamp
	2,   // 29: palm.balsam.v1.WechatOauth2UserIndexResponse.Item.sex:type_name -> palm.balsam.v1.WechatOauth2UserIndexResponse.Item.Sex
	3,   // 30: palm.balsam.v1.WechatOauth2UserIndexResponse.Item.lang:type_name -> palm.balsam.v1.WechatOauth2UserIndexResponse.Item.Lang
	52,  // 31: palm.balsam.v1.WechatOauth2UserIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 32: palm.balsam.v1.WechatOauth2UserIndexResponse.Item.updated_at:type_name -> google.protobuf.Timestamp
	52,  // 33: palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 34: palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item.updated_at:type_name -> google.protobuf.Timestamp
	1,   // 35: palm.balsam.v1.SessionIndexResponse.Item.provider_type:type_name -> palm.balsam.v1.UserSignInResponse.Detail.ProviderType
	52,  // 36: palm.balsam.v1.SessionIndexResponse.Item.expires_at:type_name -> google.protobuf.Timestamp
	52,  // 37: palm.balsam.v1.SessionIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 38: palm.balsam.v1.SessionIndexResponse.Item.created_at:type_name -> google.protobuf.Timestamp
	52,  // 39: palm.balsam.v1.AttachmentIndexResponse.Item.published_at:type_name -> google.protobuf.Timestamp
	52,  // 40: palm.balsam.v1.AttachmentIndexResponse.Item.deleted_at:type_name -> google.protobuf.Timestamp
	52,  // 41: palm.balsam.v1.AttachmentIndexResponse.Item.updated_at:type_name -> google.protobuf.Timestamp
	7,   // 42: palm.balsam.v1.Aes.Encrypt:input_type -> palm.balsam.v1.AesPlainMessage
	8,   // 43: palm.balsam.v1.Aes.Decrypt:input_type -> palm.balsam.v1.AesCodeMessage
	9,   // 44: palm.balsam.v1.Jwt.Sign:input_type -> palm.balsam.v1.JwtSignRequest
	11,  // 45: palm.balsam.v1.Jwt.Verify:input_type -> palm.balsam.v1.JwtVerifyRequest
	13,  // 46: palm.balsam.v1.HMac.Sign:input_type -> palm.balsam.v1.HMacSignRequest
	15,  // 47: palm.balsam.v1.HMac.Verify:input_type -> palm.balsam.v1.HMacVerifyRequest
	4,   // 48: palm.balsam.v1.User.Lock:input_type -> palm.balsam.v1.IdRequest
	4,   // 49: palm.balsam.v1.User.Unlock:input_type -> palm.balsam.v1.IdRequest
	4,   // 50: palm.balsam.v1.User.Disable:input_type -> palm.balsam.v1.IdRequest
	4,   // 51: palm.balsam.v1.User.Enable:input_type -> palm.balsam.v1.IdRequest
	18,  // 52: palm.balsam.v1.User.Logs:input_type -> palm.balsam.v1.LogsRequest
	54,  // 53: palm.balsam.v1.User.SignOut:input_type -> google.protobuf.Empty
	6,   // 54: palm.balsam.v1.User.Index:input_type -> palm.balsam.v1.Pager
	16,  // 55: palm.balsam.v1.User.UpdateProfile:input_type -> palm.balsam.v1.UserUpdateProfileRequest
	4,   // 56: palm.balsam.v1.User.ById:input_type -> palm.balsam.v1.IdRequest
	5,   // 57: palm.balsam.v1.User.ByUid:input_type -> palm.balsam.v1.UidRequest
	26,  // 58: palm.balsam.v1.EmailUser.SignIn:input_type -> palm.balsam.v1.UserSignInByEmailRequest
	27,  // 59: palm.balsam.v1.EmailUser.SignUp:input_type -> palm.balsam.v1.UserSignUpByEmailRequest
	24,  // 60: palm.balsam.v1.EmailUser.ConfirmByEmail:input_type -> palm.balsam.v1.UserByEmailRequest
	25,  // 61: palm.balsam.v1.EmailUser.ConfirmByToken:input_type -> palm.balsam.v1.UserByTokenRequest
	24,  // 62: palm.balsam.v1.EmailUser.UnlockByEmail:input_type -> palm.balsam.v1.UserByEmailRequest
	25,  // 63: palm.balsam.v1.EmailUser.UnlockByToken:input_type -> palm.balsam.v1.UserByTokenRequest
	24,  // 64: palm.balsam.v1.EmailUser.ForgotPassword:input_type -> palm.balsam.v1.UserByEmailRequest
	23,  // 65: palm.balsam.v1.EmailUser.ResetPassword:input_type -> palm.balsam.v1.UserResetPasswordRequest
	4,   // 66: palm.balsam.v1.EmailUser.Confirm:input_type -> palm.balsam.v1.IdRequest
	4,   // 67: palm.balsam.v1.EmailUser.Disable:input_type -> palm.balsam.v1.IdRequest
	4,   // 68: palm.balsam.v1.EmailUser.Enable:input_type -> palm.balsam.v1.IdRequest
	6,   // 69: palm.balsam.v1.EmailUser.Index:input_type -> palm.balsam.v1.Pager
	4,   // 70: palm.balsam.v1.EmailUser.ById:input_type -> palm.balsam.v1.IdRequest
	21,  // 71: palm.balsam.v1.EmailUser.ByNickname:input_type -> palm.balsam.v1.EmailUserByNicknameRequest
	20,  // 72: palm.balsam.v1.EmailUser.ByEmail:input_type -> palm.balsam.v1.EmailUserByEmailRequest
	4,   // 73: palm.balsam.v1.GoogleOauth2User.Disable:input_type -> palm.balsam.v1.IdRequest
	4,   // 74: palm.balsam.v1.GoogleOauth2User.Enable:input_type -> palm.balsam.v1.IdRequest
	6,   // 75: palm.balsam.v1.GoogleOauth2User.Index:input_type -> palm.balsam.v1.Pager
	4,   // 76: palm.balsam.v1.GoogleOauth2User.ById:input_type -> palm.balsam.v1.IdRequest
	29,  // 77: palm.balsam.v1.GoogleOauth2User.BySubject:input_type -> palm.balsam.v1.GoogleOauth2UserBySubjectRequest
	4,   // 78: palm.balsam.v1.WechatOauth2User.Disable:input_type -> palm.balsam.v1.IdRequest
	4,   // 79: palm.balsam.v1.WechatOauth2User.Enable:input_type -> palm.balsam.v1.IdRequest
	6,   // 80: palm.balsam.v1.WechatOauth2User.Index:input_type -> palm.balsam.v1.Pager
	4,   // 81: palm.balsam.v1.WechatOauth2User.ById:input_type -> palm.balsam.v1.IdRequest
	31,  // 82: palm.balsam.v1.WechatOauth2User.ByUnionId:input_type -> palm.balsam.v1.WechatByUnionIdRequest
	32,  // 83: palm.balsam.v1.WechatOauth2User.ByAppIdAndUnionId:input_type -> palm.balsam.v1.WechatByAppIdAndOpenIdRequest
	4,   // 84: palm.balsam.v1.WechatMiniProgramUser.Disable:input_type -> palm.balsam.v1.IdRequest
	4,   // 85: palm.balsam.v1.WechatMiniProgramUser.Enable:input_type -> palm.balsam.v1.IdRequest
	6,   // 86: palm.balsam.v1.WechatMiniProgramUser.Index:input_type -> palm.balsam.v1.Pager
	4,   // 87: palm.balsam.v1.WechatMiniProgramUser.ById:input_type -> palm.balsam.v1.IdRequest
	31,  // 88: palm.balsam.v1.WechatMiniProgramUser.ByUnionId:input_type -> palm.balsam.v1.WechatByUnionIdRequest
	32,  // 89: palm.balsam.v1.WechatMiniProgramUser.ByAppIdAndUnionId:input_type -> palm.balsam.v1.WechatByAppIdAndOpenIdRequest
	4,   // 90: palm.balsam.v1.Session.Disable:input_type -> palm.balsam.v1.IdRequest
	6,   // 91: palm.balsam.v1.Session.Index:input_type -> palm.balsam.v1.Pager
	4,   // 92: palm.balsam.v1.Session.ByUser:input_type -> palm.balsam.v1.IdRequest
	4,   // 93: palm.balsam.v1.Attachment.Disable:input_type -> palm.balsam.v1.IdRequest
	6,   // 94: palm.balsam.v1.Attachment.Index:input_type -> palm.balsam.v1.Pager
	38,  // 95: palm.balsam.v1.Attachment.SetTitle:input_type -> palm.balsam.v1.AttachmentSetTitleRequest
	4,   // 96: palm.balsam.v1.Attachment.ById:input_type -> palm.balsam.v1.IdRequest
	4,   // 97: palm.balsam.v1.Attachment.ByUser:input_type -> palm.balsam.v1.IdRequest
	4,   // 98: palm.balsam.v1.Attachment.ByResourceType:input_type -> palm.balsam.v1.IdRequest
	54,  // 99: palm.balsam.v1.Attachment.Clear:input_type -> google.protobuf.Empty
	37,  // 100: palm.balsam.v1.Attachment.ByResource:input_type -> palm.balsam.v1.AttachmentByResourceRequest
	36,  // 101: palm.balsam.v1.Attachment.Create:input_type -> palm.balsam.v1.AttachmentCreateRequest
	4,   // 102: palm.balsam.v1.Attachment.SetUploadedAt:input_type -> palm.balsam.v1.IdRequest
	8,   // 103: palm.balsam.v1.Aes.Encrypt:output_type -> palm.balsam.v1.AesCodeMessage
	7,   // 104: palm.balsam.v1.Aes.Decrypt:output_type -> palm.balsam.v1.AesPlainMessage
	10,  // 105: palm.balsam.v1.Jwt.Sign:output_type -> palm.balsam.v1.JwtSignResponse
	12,  // 106: palm.balsam.v1.Jwt.Verify:output_type -> palm.balsam.v1.JwtVerifyResponse
	14,  // 107: palm.balsam.v1.HMac.Sign:output_type -> palm.balsam.v1.HMacSignResponse
	54,  // 108: palm.balsam.v1.HMac.Verify:output_type -> google.protobuf.Empty
	54,  // 109: palm.balsam.v1.User.Lock:output_type -> google.protobuf.Empty
	54,  // 110: palm.balsam.v1.User.Unlock:output_type -> google.protobuf.Empty
	54,  // 111: palm.balsam.v1.User.Disable:output_type -> google.protobuf.Empty
	54,  // 112: palm.balsam.v1.User.Enable:output_type -> google.protobuf.Empty
	19,  // 113: palm.balsam.v1.User.Logs:output_type -> palm.balsam.v1.UserLogsResponse
	54,  // 114: palm.balsam.v1.User.SignOut:output_type -> google.protobuf.Empty
	17,  // 115: palm.balsam.v1.User.Index:output_type -> palm.balsam.v1.UserIndexResponse
	54,  // 116: palm.balsam.v1.User.UpdateProfile:output_type -> google.protobuf.Empty
	41,  // 117: palm.balsam.v1.User.ById:output_type -> palm.balsam.v1.UserIndexResponse.Item
	41,  // 118: palm.balsam.v1.User.ByUid:output_type -> palm.balsam.v1.UserIndexResponse.Item
	28,  // 119: palm.balsam.v1.EmailUser.SignIn:output_type -> palm.balsam.v1.UserSignInResponse
	28,  // 120: palm.balsam.v1.EmailUser.SignUp:output_type -> palm.balsam.v1.UserSignInResponse
	54,  // 121: palm.balsam.v1.EmailUser.ConfirmByEmail:output_type -> google.protobuf.Empty
	54,  // 122: palm.balsam.v1.EmailUser.ConfirmByToken:output_type -> google.protobuf.Empty
	54,  // 123: palm.balsam.v1.EmailUser.UnlockByEmail:output_type -> google.protobuf.Empty
	54,  // 124: palm.balsam.v1.EmailUser.UnlockByToken:output_type -> google.protobuf.Empty
	54,  // 125: palm.balsam.v1.EmailUser.ForgotPassword:output_type -> google.protobuf.Empty
	54,  // 126: palm.balsam.v1.EmailUser.ResetPassword:output_type -> google.protobuf.Empty
	54,  // 127: palm.balsam.v1.EmailUser.Confirm:output_type -> google.protobuf.Empty
	54,  // 128: palm.balsam.v1.EmailUser.Disable:output_type -> google.protobuf.Empty
	54,  // 129: palm.balsam.v1.EmailUser.Enable:output_type -> google.protobuf.Empty
	22,  // 130: palm.balsam.v1.EmailUser.Index:output_type -> palm.balsam.v1.EmailUserIndexResponse
	43,  // 131: palm.balsam.v1.EmailUser.ById:output_type -> palm.balsam.v1.EmailUserIndexResponse.Item
	43,  // 132: palm.balsam.v1.EmailUser.ByNickname:output_type -> palm.balsam.v1.EmailUserIndexResponse.Item
	43,  // 133: palm.balsam.v1.EmailUser.ByEmail:output_type -> palm.balsam.v1.EmailUserIndexResponse.Item
	54,  // 134: palm.balsam.v1.GoogleOauth2User.Disable:output_type -> google.protobuf.Empty
	54,  // 135: palm.balsam.v1.GoogleOauth2User.Enable:output_type -> google.protobuf.Empty
	30,  // 136: palm.balsam.v1.GoogleOauth2User.Index:output_type -> palm.balsam.v1.GoogleOauth2UserIndexResponse
	47,  // 137: palm.balsam.v1.GoogleOauth2User.ById:output_type -> palm.balsam.v1.GoogleOauth2UserIndexResponse.Item
	47,  // 138: palm.balsam.v1.GoogleOauth2User.BySubject:output_type -> palm.balsam.v1.GoogleOauth2UserIndexResponse.Item
	54,  // 139: palm.balsam.v1.WechatOauth2User.Disable:output_type -> google.protobuf.Empty
	54,  // 140: palm.balsam.v1.WechatOauth2User.Enable:output_type -> google.protobuf.Empty
	33,  // 141: palm.balsam.v1.WechatOauth2User.Index:output_type -> palm.balsam.v1.WechatOauth2UserIndexResponse
	48,  // 142: palm.balsam.v1.WechatOauth2User.ById:output_type -> palm.balsam.v1.WechatOauth2UserIndexResponse.Item
	48,  // 143: palm.balsam.v1.WechatOauth2User.ByUnionId:output_type -> palm.balsam.v1.WechatOauth2UserIndexResponse.Item
	48,  // 144: palm.balsam.v1.WechatOauth2User.ByAppIdAndUnionId:output_type -> palm.balsam.v1.WechatOauth2UserIndexResponse.Item
	54,  // 145: palm.balsam.v1.WechatMiniProgramUser.Disable:output_type -> google.protobuf.Empty
	54,  // 146: palm.balsam.v1.WechatMiniProgramUser.Enable:output_type -> google.protobuf.Empty
	34,  // 147: palm.balsam.v1.WechatMiniProgramUser.Index:output_type -> palm.balsam.v1.WechatMiniProgramUserIndexResponse
	49,  // 148: palm.balsam.v1.WechatMiniProgramUser.ById:output_type -> palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item
	49,  // 149: palm.balsam.v1.WechatMiniProgramUser.ByUnionId:output_type -> palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item
	49,  // 150: palm.balsam.v1.WechatMiniProgramUser.ByAppIdAndUnionId:output_type -> palm.balsam.v1.WechatMiniProgramUserIndexResponse.Item
	54,  // 151: palm.balsam.v1.Session.Disable:output_type -> google.protobuf.Empty
	35,  // 152: palm.balsam.v1.Session.Index:output_type -> palm.balsam.v1.SessionIndexResponse
	35,  // 153: palm.balsam.v1.Session.ByUser:output_type -> palm.balsam.v1.SessionIndexResponse
	54,  // 154: palm.balsam.v1.Attachment.Disable:output_type -> google.protobuf.Empty
	40,  // 155: palm.balsam.v1.Attachment.Index:output_type -> palm.balsam.v1.AttachmentIndexResponse
	54,  // 156: palm.balsam.v1.Attachment.SetTitle:output_type -> google.protobuf.Empty
	51,  // 157: palm.balsam.v1.Attachment.ById:output_type -> palm.balsam.v1.AttachmentIndexResponse.Item
	40,  // 158: palm.balsam.v1.Attachment.ByUser:output_type -> palm.balsam.v1.AttachmentIndexResponse
	40,  // 159: palm.balsam.v1.Attachment.ByResourceType:output_type -> palm.balsam.v1.AttachmentIndexResponse
	54,  // 160: palm.balsam.v1.Attachment.Clear:output_type -> google.protobuf.Empty
	40,  // 161: palm.balsam.v1.Attachment.ByResource:output_type -> palm.balsam.v1.AttachmentIndexResponse
	54,  // 162: palm.balsam.v1.Attachment.Create:output_type -> google.protobuf.Empty
	54,  // 163: palm.balsam.v1.Attachment.SetUploadedAt:output_type -> google.protobuf.Empty
	103, // [103:164] is the sub-list for method output_type
	42,  // [42:103] is the sub-list for method input_type
...
func file_balsam_proto_init() {
	...
	file_balsam_proto_msgTypes[37].OneofWrappers = []interface{}{}
	file_balsam_proto_msgTypes[38].OneofWrappers = []interface{}{}
	file_balsam_proto_msgTypes[39].OneofWrappers = []interface{}{}
	file_balsam_proto_msgTypes[40].OneofWrappers = []interface{}{}
	file_balsam_proto_msgTypes[41].OneofWrappers = []interface{}{}
	file_balsam_proto_msgTypes[42].OneofWrappers = []interface{}{}
