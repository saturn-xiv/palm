...
// UnimplementedGoogleOauth2UserServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedGoogleOauth2UserServer) testEmbeddedByValue()                          {}
...
func RegisterGoogleOauth2UserServer(s grpc.ServiceRegistrar, srv GoogleOauth2UserServer) {
	// If the following call pancis, it indicates UnimplementedGoogleOauth2UserServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedWechatOauth2UserServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedWechatOauth2UserServer) testEmbeddedByValue()                          {}
...
func RegisterWechatOauth2UserServer(s grpc.ServiceRegistrar, srv WechatOauth2UserServer) {
	// If the following call pancis, it indicates UnimplementedWechatOauth2UserServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedWechatMiniProgramUserServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedWechatMiniProgramUserServer) testEmbeddedByValue()                               {}
...
func RegisterWechatMiniProgramUserServer(s grpc.ServiceRegistrar, srv WechatMiniProgramUserServer) {
	// If the following call pancis, it indicates UnimplementedWechatMiniProgramUserServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedLeaveWordServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedLeaveWordServer) testEmbeddedByValue()                   {}
...
func RegisterLeaveWordServer(s grpc.ServiceRegistrar, srv LeaveWordServer) {
	// If the following call pancis, it indicates UnimplementedLeaveWordServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
