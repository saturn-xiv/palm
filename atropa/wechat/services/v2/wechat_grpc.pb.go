...
// UnimplementedMiniProgramServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedMiniProgramServer) testEmbeddedByValue()                     {}
...
func RegisterMiniProgramServer(s grpc.ServiceRegistrar, srv MiniProgramServer) {
	// If the following call pancis, it indicates UnimplementedMiniProgramServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedPayNativeServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedPayNativeServer) testEmbeddedByValue()                   {}
...
func RegisterPayNativeServer(s grpc.ServiceRegistrar, srv PayNativeServer) {
	// If the following call pancis, it indicates UnimplementedPayNativeServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedPayJsapiServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedPayJsapiServer) testEmbeddedByValue()                  {}
...
func RegisterPayJsapiServer(s grpc.ServiceRegistrar, srv PayJsapiServer) {
	// If the following call pancis, it indicates UnimplementedPayJsapiServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedPayBillServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedPayBillServer) testEmbeddedByValue()                 {}
...
func RegisterPayBillServer(s grpc.ServiceRegistrar, srv PayBillServer) {
	// If the following call pancis, it indicates UnimplementedPayBillServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedPayRefundServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedPayRefundServer) testEmbeddedByValue()                   {}
...
func RegisterPayRefundServer(s grpc.ServiceRegistrar, srv PayRefundServer) {
	// If the following call pancis, it indicates UnimplementedPayRefundServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
// UnimplementedPayTransferServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedPayTransferServer) testEmbeddedByValue()                     {}
...
func RegisterPayTransferServer(s grpc.ServiceRegistrar, srv PayTransferServer) {
	// If the following call pancis, it indicates UnimplementedPayTransferServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
