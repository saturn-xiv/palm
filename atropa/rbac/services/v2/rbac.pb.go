...
func (x *PolicyUsersResponse_Item) GetI() uint64 {
...
type PolicyUsersResponse_Item_I struct {
	I uint64 `protobuf:"varint,2,opt,name=i,proto3,oneof"`
}
...
func (x *PolicyPermissionsResponse_Item_Resource_Id) GetI() uint64 {
...
type PolicyPermissionsResponse_Item_Resource_Id_I struct {
	I uint64 `protobuf:"varint,11,opt,name=i,proto3,oneof"`
}
...
var file_rbac_proto_rawDesc = []byte{
	...
	0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x01, 0x69, 0x12, 0x0e, 0x0a, 0x01,
	...
	0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x01, 0x69, 0x12, 0x0e, 0x0a, 0x01, 0x73, 0x18, 0x0c,
...
func file_rbac_proto_init() {
	...
	file_rbac_proto_msgTypes[8].OneofWrappers = []any{
	...
	file_rbac_proto_msgTypes[13].OneofWrappers = []any{}
