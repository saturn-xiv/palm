...
PROTOBUF_NDEBUG_INLINE Task::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::palm::sms::v1::Task& from_msg)
...
Task::_table_ = {
  {
    ...
    // string from = 1;
    {PROTOBUF_FIELD_OFFSET(Task, _impl_.from_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated string to = 2;
