...
add_requires("libpq", "libsodium", "cpr", "grpc 1.68.2")
add_requires("poco", {configs = {crypto = true, json = true, jwt = true, utils = true, net = true, data = true, mysql = false, postgresql = true, redis = true}})
