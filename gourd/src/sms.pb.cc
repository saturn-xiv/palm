...
PROTOBUF_NDEBUG_INLINE Task::Impl_::Impl_(
    ...
    const ::palm::sms::v1::Task& from_msg)
...
Task::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {10, 0, 0, PROTOBUF_FIELD_OFFSET(Task, _impl_.from_)}},
    // repeated string to = 2;
    {::_pbi::TcParser::FastUR1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(Task, _impl_.to_)}},
    // string body = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 1, 0, PROTOBUF_FIELD_OFFSET(Task, _impl_.body_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string from = 1;
    {PROTOBUF_FIELD_OFFSET(Task, _impl_.from_), _Internal::kHasBitsOffset + 0, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated string to = 2;
    {PROTOBUF_FIELD_OFFSET(Task, _impl_.to_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kUtf8String | ::_fl::kRepSString)},
    // string body = 3;
    {PROTOBUF_FIELD_OFFSET(Task, _impl_.body_), _Internal::kHasBitsOffset + 1, 0,
    (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
