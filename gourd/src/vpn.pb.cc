...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_vpn_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_vpn_2eproto = nullptr;
const ::uint32_t TableStruct_vpn_2eproto::offsets[1] = {};
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_vpn_2eproto = {
    ...
    TableStruct_vpn_2eproto::offsets,
    file_level_enum_descriptors_vpn_2eproto,
    file_level_service_descriptors_vpn_2eproto,
};
namespace palm {
namespace vpn {
namespace v1 {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_vpn_2eproto),
         ::std::false_type{});
