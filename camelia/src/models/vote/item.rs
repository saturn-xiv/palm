...
pub trait Dao {
    fn get(&mut self, id: i64) -> Result<Item>;
    fn by_resource(&mut self, type_: &str, id: i64) -> Result<Item>;
    fn create(&mut self, resource_type: &str, resource_id: i64, star: i32) -> Result<()>;
    fn update(&mut self, id: i64, star: i32) -> Result<()>;
