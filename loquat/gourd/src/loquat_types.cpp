...
bool JwtVerfifyResponse::operator==(const JwtVerfifyResponse & rhs) const
{
...
bool JwtSignRequest::operator==(const JwtSignRequest & rhs) const
{
  if (__isset.jwt_id != rhs.__isset.jwt_id)
    return false;
  else if (__isset.jwt_id && !(jwt_id == rhs.jwt_id))
...
PasswordHashingResponse::~PasswordHashingResponse() noexcept {
}
...
void PasswordHashingResponse::__set_code(const std::string& val) {
  this->code = val;
}

void PasswordHashingResponse::__set_salt(const std::string& val) {
  this->salt = val;
}
...
uint32_t PasswordHashingResponse::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t PasswordHashingResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("PasswordHashingResponse");
...
bool PasswordHashingResponse::operator==(const PasswordHashingResponse & rhs) const
{
  if (!(code == rhs.code))
    return false;
  if (!(salt == rhs.salt))
...
PasswordHashingResponse::PasswordHashingResponse(const PasswordHashingResponse& other11) {
  code = other11.code;
  salt = other11.salt;
}
PasswordHashingResponse& PasswordHashingResponse::operator=(const PasswordHashingResponse& other12) {
  code = other12.code;
  salt = other12.salt;
  return *this;
}
void PasswordHashingResponse::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "PasswordHashingResponse(";
