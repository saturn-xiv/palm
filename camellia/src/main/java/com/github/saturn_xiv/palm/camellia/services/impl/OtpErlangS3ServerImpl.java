...
@Component("palm.camellia.otp-erlang-s3-server")
public class OtpErlangS3ServerImpl extends OtpErlangServer {
    ...
    void init() throws IOException {
        super.launch(nodeName, "s3", cookie);
    }
    ...
    @Resource
    S3Helper s3Helper;
    private static final Logger logger = LoggerFactory.getLogger(OtpErlangS3ServerImpl.class);
}
