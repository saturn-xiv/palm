...
use redis::{Commands, cluster::ClusterConnection as RedisClusterConnection};
...
impl Client for super::Client {
    ...
    fn set_tokens(
        ...
        let _: String = Commands::set_ex(cache, &access_token_key, access_token, expires_in - 60)?;
        let _: String = Commands::set_ex(
            cache,
            &refresh_token_key,
            refresh_token,
            60 * 60 * 24 * (30 - 1),
