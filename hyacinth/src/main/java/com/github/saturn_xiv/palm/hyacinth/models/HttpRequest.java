...
public record HttpRequest(String x_real_ip, String authorization, String package_, String service, String method,
                String requestType, String requestBody) {
        ...
        public Optional<MessageOrBuilder> execute(ManagedChannel channel)
                ...
                if (x_real_ip != null) {
                        Metadata.Key<String> key = Metadata.Key.of(HttpHeaders.X_REAL_IP.toLowerCase(),
                                        Metadata.ASCII_STRING_MARSHALLER);
                        header.put(key, x_real_ip);
                }
