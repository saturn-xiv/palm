...
impl<'a> Address<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Address::VT_NAME, None)}
  }
  #[inline]
  pub fn email(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Address::VT_EMAIL, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> AddressBuilder<'a, 'b, A> {
  ...
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Address::VT_NAME, name);
  }
  #[inline]
  pub fn add_email(&mut self, email: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Address::VT_EMAIL, email);
  }
  #[inline]
...
impl<'a> Body<'a> {
  ...
  pub fn content(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Body::VT_CONTENT, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> BodyBuilder<'a, 'b, A> {
  ...
  pub fn add_content(&mut self, content: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Body::VT_CONTENT, content);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> BodyBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BodyBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Attachment<'a> {
  ...
  pub fn inline(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Attachment::VT_INLINE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    // Safety:
  ...
  pub fn body(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u8>>>(Attachment::VT_BODY, None)}
  }
  #[inline]
  pub fn content_type(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Attachment::VT_CONTENT_TYPE, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> AttachmentBuilder<'a, 'b, A> {
  ...
  pub fn add_inline(&mut self, inline: bool) {
    self.fbb_.push_slot::<bool>(Attachment::VT_INLINE, inline, false);
  }
  #[inline]
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
  ...
  pub fn add_body(&mut self, body: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Attachment::VT_BODY, body);
  }
  #[inline]
  pub fn add_content_type(&mut self, content_type: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Attachment::VT_CONTENT_TYPE, content_type);
  }
  #[inline]
...
impl<'a> Email<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.bcc { builder.add_bcc(x); }
    if let Some(x) = args.cc { builder.add_cc(x); }
  ...
  pub fn from(&self) -> Option<Address<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Address>>(Email::VT_FROM, None)}
  }
  #[inline]
  pub fn to(&self) -> Option<Address<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Address>>(Email::VT_TO, None)}
  }
  #[inline]
  pub fn cc(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Address<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Address>>>>(Email::VT_CC, None)}
  }
  #[inline]
  pub fn bcc(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Address<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Address>>>>(Email::VT_BCC, None)}
  }
  #[inline]
  pub fn subject(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Email::VT_SUBJECT, None)}
  }
  #[inline]
  pub fn body(&self) -> Option<Body<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<Body>>(Email::VT_BODY, None)}
  }
  #[inline]
  pub fn attachments(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Attachment<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Attachment>>>>(Email::VT_ATTACHMENTS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for Email<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<Address>>("from", Self::VT_FROM, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<Address>>("to", Self::VT_TO, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Address>>>>("cc", Self::VT_CC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<Address>>>>("bcc", Self::VT_BCC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("subject", Self::VT_SUBJECT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<Body>>("body", Self::VT_BODY, false)?
...
pub struct EmailArgs<'a> {
    ...
    pub cc: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Address<'a>>>>>,
    pub bcc: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<Address<'a>>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> EmailBuilder<'a, 'b, A> {
  ...
  pub fn add_from(&mut self, from: ::flatbuffers::WIPOffset<Address<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<Address>>(Email::VT_FROM, from);
  }
  #[inline]
  pub fn add_to(&mut self, to: ::flatbuffers::WIPOffset<Address<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<Address>>(Email::VT_TO, to);
  }
  #[inline]
  pub fn add_cc(&mut self, cc: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<Address<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Email::VT_CC, cc);
  }
  #[inline]
  pub fn add_bcc(&mut self, bcc: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<Address<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Email::VT_BCC, bcc);
  }
  #[inline]
  pub fn add_subject(&mut self, subject: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Email::VT_SUBJECT, subject);
  }
  #[inline]
  pub fn add_body(&mut self, body: ::flatbuffers::WIPOffset<Body<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<Body>>(Email::VT_BODY, body);
  }
  #[inline]
  pub fn add_attachments(&mut self, attachments: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<Attachment<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Email::VT_ATTACHMENTS, attachments);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> EmailBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    EmailBuilder {
      fbb_: _fbb,
      start_: start,
