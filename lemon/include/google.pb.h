...
class Oauth2SignInResponse_OpenId final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.google.v1.Oauth2SignInResponse.OpenId) */ {
 public:
  inline Oauth2SignInResponse_OpenId() : Oauth2SignInResponse_OpenId(nullptr) {}
  ~Oauth2SignInResponse_OpenId() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Oauth2SignInResponse_OpenId(::google::protobuf::internal::ConstantInitialized);

  inline Oauth2SignInResponse_OpenId(const Oauth2SignInResponse_OpenId& from)
      : Oauth2SignInResponse_OpenId(nullptr, from) {}
...
class Oauth2SignInRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.google.v1.Oauth2SignInRequest) */ {
 public:
...
class Oauth2AuthCodeURLResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.google.v1.Oauth2AuthCodeURLResponse) */ {
 public:
  inline Oauth2AuthCodeURLResponse() : Oauth2AuthCodeURLResponse(nullptr) {}
  ~Oauth2AuthCodeURLResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Oauth2AuthCodeURLResponse(::google::protobuf::internal::ConstantInitialized);

  inline Oauth2AuthCodeURLResponse(const Oauth2AuthCodeURLResponse& from)
      : Oauth2AuthCodeURLResponse(nullptr, from) {}
...
class Oauth2AuthCodeURLRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.google.v1.Oauth2AuthCodeURLRequest) */ {
 public:
  inline Oauth2AuthCodeURLRequest() : Oauth2AuthCodeURLRequest(nullptr) {}
  ~Oauth2AuthCodeURLRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Oauth2AuthCodeURLRequest(::google::protobuf::internal::ConstantInitialized);

  inline Oauth2AuthCodeURLRequest(const Oauth2AuthCodeURLRequest& from)
      : Oauth2AuthCodeURLRequest(nullptr, from) {}
...
class Oauth2SignInResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.google.v1.Oauth2SignInResponse) */ {
 public:
...
inline ::palm::google::v1::Oauth2SignInResponse_OpenId* Oauth2SignInResponse::_internal_mutable_open_id() {
  ...
  if (_impl_.open_id_ == nullptr) {
    auto* p = CreateMaybeMessage<::palm::google::v1::Oauth2SignInResponse_OpenId>(GetArena());
...
inline void Oauth2SignInResponse::set_allocated_open_id(::palm::google::v1::Oauth2SignInResponse_OpenId* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::palm::google::v1::Oauth2SignInResponse_OpenId*>(_impl_.open_id_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::palm::google::v1::Oauth2SignInResponse_OpenId*>(value)->GetArena();
